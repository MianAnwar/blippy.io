...
import 'package:total_app/UI/B5_Profile/ListProfile/TSViewProfile.dart';
import 'package:total_app/UI/IntroApps/Login.dart';

class TSProfileScreen extends StatefulWidget {
  final String email;
  TSProfileScreen({Key key, this.email}) : super(key: key);

  @override
  _TSProfileScreenState createState() => _TSProfileScreenState();
}

class _TSProfileScreenState extends State<TSProfileScreen> {
  String username;
