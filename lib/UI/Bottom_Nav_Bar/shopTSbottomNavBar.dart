...
import 'package:total_app/UI/B1_Home/B1_Home_Screen/TSSearch.dart';
...
class ShopBtmNavBar extends StatefulWidget {
  final String email;
  ShopBtmNavBar({this.email});

  ShopBtmNavBarState createState() => ShopBtmNavBarState();
}

class ShopBtmNavBarState extends State<ShopBtmNavBar> {
  int currentIndex = 0;
  //
  Widget callPage(int current) {
    switch (current) {
      ...
      case 3:
        ...
        break;
      case 4:
        return new TSBusinessProfileScreen(email: widget.email);
        break;
      default:
        return new ShopMain();
    }
