...
class TSProducts extends StatefulWidget {
  @override
  _TSProductsState createState() => _TSProductsState();
}

class _TSProductsState extends State<TSProducts> {
  bool loadImage = true;
  ...
  var loadImageAnimation = Container(
    ...
    child: ListView.builder(
      itemBuilder: (ctx, index) {
        return cardLoading(hotelDataDummy[index]);
      },
