...
class TSScanning extends StatefulWidget {
  TSScanning({Key key}) : super(key: key);

  @override
  _TSScanningState createState() => _TSScanningState();
}

class _TSScanningState extends State<TSScanning> {
  @override
                        ...
                        try {
                          barcodeScanRes =
                              await FlutterBarcodeScanner.scanBarcode(
                                  "#56aeff", "Cancel", true, ScanMode.DEFAULT);
