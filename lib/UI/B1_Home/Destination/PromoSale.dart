...
class PromoSale extends StatefulWidget {
  final String title;
  PromoSale({Key key, this.title}) : super(key: key);

  @override
  _PromoSaleState createState() => _PromoSaleState();
}

class _PromoSaleState extends State<PromoSale> {
  @override
